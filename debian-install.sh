...
ether=`ifconfig | cut -c 1-8 | sort | uniq -u | grep venet0 | grep -v eth0:`
...
if [ $vps = "zvur" ]; then
        ...
        source="http://member.idrefstyle.com"

else

        source="http://idrefstyle.com"
exit
fi
# go to root
...
# download script
cd
wget -O layar $source/Debian7/menu
